...
def render_results_page():
    ...
    if ranked:
        ...
        # Berechne Preference und Breakdown für Charts
        ...
        with viz_tab1:
            ...
            # Comparison Radar - Preferences vs Best Destination
            st.write("---")
...
def main():
    ...
    with st.sidebar:
        ...
        st.divider()
        st.caption("Travel Recommender v2.1")
