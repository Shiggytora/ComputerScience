...
# Origin city for route map (Zurich as default)
DEFAULT_ORIGIN = {
    "city": "Zurich",
    "latitude": 47.3769,
    "longitude": 8.5417
...
def render_results_page():
    ...
    if ranked:
        ...
        map_tab1, map_tab2 = st.tabs(["🌍 All Matches", "✈️ Your Journey"])
...
def main():
    ...
    with st.sidebar:
        ...
        st.divider()
        st.caption("Travel Recommender v2.2")
